...
export default function EnquiryDashboard() {
    ...
    return (
      <div className="min-h-screen bg-[#F0F4F8]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 px-6 py-4">
          {[1,2,3,4].map(i => (
            <div key={i} className="bg-white rounded-xl border border-[#D0DCE8] shadow-sm p-6 animate-pulse">
  ...
  return (
    <div className="min-h-screen bg-[#F0F4F8] flex flex-col">
      ...
      {/* Stat cards */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 px-6 py-4">
        <div className="bg-white rounded-xl border border-[#D0DCE8] shadow-sm p-6">
      ...
      <div className="px-6 pb-8">
        <div className="bg-white rounded-xl border border-[#D0DCE8] shadow-sm overflow-hidden">
